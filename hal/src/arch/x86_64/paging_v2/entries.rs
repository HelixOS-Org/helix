...
impl PageFlags {
    ...
    pub const USER_RO: Self = Self::PRESENT.union(Self::USER_ACCESSIBLE).union(Self::NO_EXECUTE);
    
    /// User read-write data flags
    pub const USER_RW: Self = Self::PRESENT.union(Self::WRITABLE).union(Self::USER_ACCESSIBLE).union(Self::NO_EXECUTE);
    ...
    pub const TABLE: Self = Self::PRESENT.union(Self::WRITABLE).union(Self::USER_ACCESSIBLE);
