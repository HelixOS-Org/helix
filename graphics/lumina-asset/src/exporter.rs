...
use crate::{
    AssetResult, AssetError, AssetErrorKind, AssetType, ImportedAsset, ImportedData,
    ExportedAsset, Exporter, TextureFormat,
};
...
impl Exporter for TextureExporter {
    fn export(&self, asset: &ImportedAsset) -> AssetResult<ExportedAsset> {
        let texture = match &asset.data {
            ...
            _ => return Err(AssetError::new(AssetErrorKind::InvalidFormat, "Not a texture")),
        };
...
impl Exporter for MaterialExporter {
    fn export(&self, asset: &ImportedAsset) -> AssetResult<ExportedAsset> {
        let material = match &asset.data {
            ...
            _ => return Err(AssetError::new(AssetErrorKind::InvalidFormat, "Not a material")),
        };
...
impl Exporter for ShaderExporter {
    fn export(&self, asset: &ImportedAsset) -> AssetResult<ExportedAsset> {
        let shader = match &asset.data {
            ...
            _ => return Err(AssetError::new(AssetErrorKind::InvalidFormat, "Not a shader")),
        };
