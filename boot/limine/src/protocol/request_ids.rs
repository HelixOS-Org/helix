...
pub const STACK_SIZE_REQUEST_ID: [u64; 4] =
    make_request_id(0x224ef0460a8e8926, 0xe1cb0fc25f46ea3d);

/// Higher Half Direct Map request ID
pub const HHDM_REQUEST_ID: [u64; 4] =
    make_request_id(0x48dcf1cb8ad2b852, 0x63984e959a98244b);
...
pub const TERMINAL_REQUEST_ID: [u64; 4] =
    make_request_id(0xc8ac59310c2b0844, 0xa68d0c7265d38878);
...
pub const SMP_REQUEST_ID: [u64; 4] =
    make_request_id(0x95a67b819a1b857e, 0xa0b61b723b6a73e0);

/// Memory map request ID
pub const MEMMAP_REQUEST_ID: [u64; 4] =
    make_request_id(0x67cf3d9d378a806f, 0xe304acdfc50c3c62);
...
pub const MODULE_REQUEST_ID: [u64; 4] =
    make_request_id(0x3e7e279702be32af, 0xca1c4f3bd1280cee);

/// ACPI RSDP request ID
pub const RSDP_REQUEST_ID: [u64; 4] =
    make_request_id(0xc5e77b6b397e7b43, 0x27637845accdcf3c);

/// SMBIOS request ID
pub const SMBIOS_REQUEST_ID: [u64; 4] =
    make_request_id(0x9e9046f11e095391, 0xaa4a520fefbde5ee);
...
pub const EFI_MEMMAP_REQUEST_ID: [u64; 4] =
    make_request_id(0x7df62a431d6872d5, 0xa4fcdfb3e57306c8);

/// Boot time request ID
pub const BOOT_TIME_REQUEST_ID: [u64; 4] =
    make_request_id(0x502746e184c088aa, 0xfbc5ec83e6327893);
...
pub const DTB_REQUEST_ID: [u64; 4] =
    make_request_id(0xb40ddb48fb54bac7, 0x545081493f81ffb7);
