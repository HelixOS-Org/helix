...
impl ConnectionCoopRecord {
    pub fn new(event: ConnectionCoopEvent) -> Self {
        Self {
            event,
            tracked_conns: 0,
            nat_entries: 0,
...
#[derive(Debug, Clone)]
#[repr(align(64))]
pub struct ConnectionCoopStats {
...
#[derive(Debug)]
pub struct CoopConnection {
    pub stats: ConnectionCoopStats,
}

impl CoopConnection {
    pub fn new() -> Self {
        Self {
            stats: ConnectionCoopStats {
                total_events: 0,
                shares: 0,
                nat_syncs: 0,
                replications: 0,
    ...
    pub fn record(&mut self, rec: &ConnectionCoopRecord) {
        ...
        match rec.event {
            ...
            ConnectionCoopEvent::StateReplicate | ConnectionCoopEvent::TimeoutCoord => {
