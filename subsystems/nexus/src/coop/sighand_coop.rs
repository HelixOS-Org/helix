...
impl SighandCoopRecord {
    pub fn new(event: SighandCoopEvent) -> Self {
        Self {
            event,
            thread_count: 0,
            signals_shared: 0,
...
/// Main coop sighand
#[derive(Debug)]
pub struct CoopSighand {
    pub stats: SighandCoopStats,
}

impl CoopSighand {
    pub fn new() -> Self {
        Self {
            stats: SighandCoopStats {
                total_events: 0,
                shares: 0,
                cows: 0,
                propagations: 0,
    ...
    pub fn record(&mut self, rec: &SighandCoopRecord) {
        ...
        match rec.event {
            ...
            SighandCoopEvent::HandlerSync | SighandCoopEvent::MaskPropagate => {
