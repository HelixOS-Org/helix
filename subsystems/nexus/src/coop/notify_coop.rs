...
impl NotifyCoopRecord {
    pub fn new(event: NotifyCoopEvent) -> Self {
        Self {
            event,
            subscribers: 0,
            notifications: 0,
...
/// Main coop notify
#[derive(Debug)]
pub struct CoopNotify {
    pub stats: NotifyCoopStats,
}

impl CoopNotify {
    pub fn new() -> Self {
        Self {
            stats: NotifyCoopStats {
                total_events: 0,
                fanouts: 0,
                coalesced: 0,
                filtered: 0,
