...
impl CongestionCoopRecord {
    pub fn new(event: CongestionCoopEvent) -> Self {
        Self {
            event,
            cwnd: 0,
            ssthresh: 0,
...
#[derive(Debug, Clone)]
#[repr(align(64))]
pub struct CongestionCoopStats {
    pub total_events: u64,
    pub syncs: u64,
    pub group_starts: u64,
    pub recoveries: u64,
}

/// Main coop congestion
#[derive(Debug)]
pub struct CoopCongestion {
    pub stats: CongestionCoopStats,
}

impl CoopCongestion {
    pub fn new() -> Self {
        Self {
            stats: CongestionCoopStats {
                total_events: 0,
                syncs: 0,
                group_starts: 0,
                recoveries: 0,
    ...
    pub fn record(&mut self, rec: &CongestionCoopRecord) {
        ...
        match rec.event {
            CongestionCoopEvent::WindowSync | CongestionCoopEvent::CongAvoidCoord => {
                self.stats.syncs += 1
            },
