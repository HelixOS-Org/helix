...
impl FutexCoopRecord {
    pub fn new(event: FutexCoopEvent) -> Self {
        Self {
            event,
            waiters: 0,
            woken: 0,
...
pub struct CoopFutex {
    pub stats: FutexCoopStats,
}

impl CoopFutex {
    pub fn new() -> Self {
        Self {
            stats: FutexCoopStats {
                total_events: 0,
                merges: 0,
                coalesced_wakes: 0,
                inherits: 0,
    ...
    pub fn record(&mut self, rec: &FutexCoopRecord) {
        ...
        match rec.event {
            ...
            FutexCoopEvent::WakeCoalesce | FutexCoopEvent::RequeueOptimize => {
                self.stats.coalesced_wakes += 1
            },
