...
impl EventfdCoopRecord {
    pub fn new(event: EventfdCoopEvent) -> Self {
        Self {
            event,
            fd_count: 0,
            waiters: 0,
...
/// Main coop eventfd
#[derive(Debug)]
pub struct CoopEventfd {
    pub stats: EventfdCoopStats,
}

impl CoopEventfd {
    pub fn new() -> Self {
        Self {
            stats: EventfdCoopStats {
                total_events: 0,
                aggregates: 0,
                fanouts: 0,
                barriers: 0,
    ...
    pub fn record(&mut self, rec: &EventfdCoopRecord) {
        ...
        match rec.event {
            ...
            EventfdCoopEvent::BarrierSync | EventfdCoopEvent::SemaphoreChain => {
