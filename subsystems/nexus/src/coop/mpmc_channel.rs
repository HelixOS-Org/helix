...
impl MpmcChannel {
    pub fn new(cap: u32) -> Self {
        Self { capacity: cap, state: MpmcState::Open, buffer: Vec::new(), senders: 0, receivers: 0, total_sent: 0, total_received: 0, total_full_blocks: 0, total_empty_blocks: 0 }
    }
