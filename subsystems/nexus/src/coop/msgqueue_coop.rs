...
impl MsgqueueCoopRecord {
    pub fn new(event: MsgqueueCoopEvent) -> Self {
        Self {
            event,
            msqid: -1,
            messages: 0,
...
/// Main coop msgqueue
#[derive(Debug)]
pub struct CoopMsgqueue {
    pub stats: MsgqueueCoopStats,
}

impl CoopMsgqueue {
    pub fn new() -> Self {
        Self {
            stats: MsgqueueCoopStats {
                total_events: 0,
                shares: 0,
                reorders: 0,
                batches: 0,
    ...
    pub fn record(&mut self, rec: &MsgqueueCoopRecord) {
        ...
        match rec.event {
            ...
            MsgqueueCoopEvent::BatchDequeue | MsgqueueCoopEvent::LoadBalance => {
