...
impl SigsuspendRecord {
    pub fn new(mask: u64) -> Self {
        Self {
            result: SigsuspendResult::Interrupted,
            mask_bits: mask,
            signal_nr: 0,
            wait_ns: 0,
            pid: 0,
...
/// Main app sigsuspend
#[derive(Debug)]
pub struct AppSigsuspend {
    pub stats: SigsuspendAppStats,
}

impl AppSigsuspend {
    pub fn new() -> Self {
        Self {
            stats: SigsuspendAppStats {
                total_ops: 0,
                total_wait_ns: 0,
            },
        }
