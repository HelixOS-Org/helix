...
/// Main app sigwait
#[derive(Debug)]
pub struct AppSigwait {
    pub stats: SigwaitAppStats,
}

impl AppSigwait {
    pub fn new() -> Self {
        Self {
            stats: SigwaitAppStats {
                total_ops: 0,
                received: 0,
                timeouts: 0,
            },
