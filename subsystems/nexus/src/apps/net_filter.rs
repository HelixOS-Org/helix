...
impl FilterRule {
    pub fn new(id: u64, name: String, action: FilterAction) -> Self {
        Self {
            ...
            protocol: NetProtocol::Any,
            src_addr: IpAddr::any_v4(),
            dst_addr: IpAddr::any_v4(),
    ...
    pub fn matches_packet(
        ...
        if !self.src_ports.contains(src_port) {
            return false;
        }
        if !self.dst_ports.contains(dst_port) {
            return false;
        }
        true
    }
...
impl AppsNetFilter {
    ...
    pub fn track_connection(&mut self, pid: u64, proto: NetProtocol) -> u64 {
        ...
        self.next_id += 1;
        self.connections
            .insert(id, ConnTrackEntry::new(id, pid, proto));
        id
    }
    ...
    pub fn add_rate_limiter(&mut self, pid: u64, max_pps: u32, max_bps: u64) {
        self.rate_limiters
            .insert(pid, RateLimiter::new(pid, max_pps, max_bps));
    }
    ...
    #[inline(always)]
    pub fn rule(&self, id: u64) -> Option<&FilterRule> {
        self.rules.get(&id)
    }
    #[inline(always)]
    pub fn connection(&self, id: u64) -> Option<&ConnTrackEntry> {
