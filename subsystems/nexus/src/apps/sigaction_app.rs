...
#[derive(Debug, Clone)]
#[repr(align(64))]
pub struct SigactionAppStats {
    pub total_ops: u64,
    pub custom_set: u64,
    pub defaults_restored: u64,
}

/// Main app sigaction
#[derive(Debug)]
pub struct AppSigaction {
    pub stats: SigactionAppStats,
}

impl AppSigaction {
    pub fn new() -> Self {
        Self {
            stats: SigactionAppStats {
                total_ops: 0,
                custom_set: 0,
                defaults_restored: 0,
            },
    ...
    pub fn record(&mut self, rec: &SigactionAppRecord) {
        ...
        match rec.handler {
            SigactionAppHandler::Custom | SigactionAppHandler::SigInfo => {
                self.stats.custom_set += 1
            },
