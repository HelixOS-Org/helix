...
impl TruncateBridgeRecord {
    pub fn new(event: TruncateBridgeEvent) -> Self {
        Self {
            event,
            fd: -1,
            old_size: 0,
...
#[derive(Debug, Clone)]
#[repr(align(64))]
pub struct TruncateBridgeStats {
    pub total_ops: u64,
    pub shrinks: u64,
    pub extends: u64,
    pub punches: u64,
...
#[derive(Debug)]
pub struct BridgeTruncate {
    pub stats: TruncateBridgeStats,
}

impl BridgeTruncate {
    pub fn new() -> Self {
        Self {
            stats: TruncateBridgeStats {
                total_ops: 0,
                shrinks: 0,
                extends: 0,
                punches: 0,
