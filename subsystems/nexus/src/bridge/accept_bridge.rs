...
impl AcceptBridgeRecord {
    pub fn new(event: AcceptBridgeEvent, listen_fd: i32) -> Self {
        Self {
            event,
            listen_fd,
            new_fd: -1,
...
/// Main bridge accept
#[derive(Debug)]
pub struct BridgeAccept {
    pub stats: AcceptBridgeStats,
}

impl BridgeAccept {
    pub fn new() -> Self {
        Self {
            stats: AcceptBridgeStats {
                total_events: 0,
                accepted: 0,
                refused: 0,
                timeouts: 0,
    ...
    pub fn record(&mut self, rec: &AcceptBridgeRecord) {
        ...
        match rec.event {
            AcceptBridgeEvent::Accepted | AcceptBridgeEvent::NonBlocking => {
