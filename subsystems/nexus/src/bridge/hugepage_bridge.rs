...
#[derive(Debug, Clone)]
pub struct BridgeHugepageAlloc {
    pub addr: u64,
    pub size: BridgeHugepageSize,
    pub count: u32,
...
pub struct BridgeHugepageStats {
    ...
    pub two_mb_pages: u64,
    pub one_gb_pages: u64,
    pub transparent_promotions: u64,
    pub total_huge_bytes: u64,
    pub defrag_attempts: u64,
}
...
impl BridgeHugepageManager {
    ...
    pub fn alloc(&mut self, addr: u64, size: BridgeHugepageSize, count: u32) -> bool {
        ...
        *pool -= count;
        self.allocs.insert(addr, BridgeHugepageAlloc {
            addr,
            size,
            count,
            transparent: false,
        ...
        match size {
            BridgeHugepageSize::TwoMB => self.stats.two_mb_pages += count as u64,
            BridgeHugepageSize::OneGB => self.stats.one_gb_pages += count as u64,
        }
    ...
    #[inline(always)]
    pub fn promote_transparent(&mut self, _addr: u64) {
        self.stats.transparent_promotions += 1;
    }
    #[inline(always)]
    pub fn stats(&self) -> &BridgeHugepageStats {
        &self.stats
    }
}
