...
use alloc::vec::Vec;
use super::types::{StateVector, Complex};
use super::gates::{GateType, apply_h, apply_x, apply_y, apply_z, apply_rx, apply_ry, apply_rz, apply_cnot, apply_cz, apply_swap, apply_toffoli};
...
impl QuantumCircuit {
    ...
    pub fn depth(&mut self) -> usize {
        ...
        for inst in &self.instructions {
            ...
            let max_depth = inst.targets.iter()
    ...
    pub fn inverse(&self) -> QuantumCircuit {
        ...
        for inst in self.instructions.iter().rev() {
            let inv_inst = match inst.gate {
                ...
                | GateType::H | GateType::CX | GateType::CZ | GateType::SWAP
