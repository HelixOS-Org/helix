...
impl SigactionHolisticRecord {
    pub fn new(pattern: SigactionPattern, signal_nr: u32) -> Self {
        Self {
            pattern,
            signal_nr,
            pid: 0,
...
#[derive(Debug, Clone)]
#[repr(align(64))]
pub struct SigactionHolisticStats {
...
#[derive(Debug)]
pub struct HolisticSigaction {
    pub stats: SigactionHolisticStats,
}

impl HolisticSigaction {
    pub fn new() -> Self {
        Self {
            stats: SigactionHolisticStats {
                total_samples: 0,
                custom_handlers: 0,
                ignored: 0,
                chained: 0,
