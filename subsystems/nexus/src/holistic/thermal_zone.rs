...
impl ThermalZone {
    ...
    pub fn is_critical(&self) -> bool {
        self.trip_points
            .iter()
            .any(|tp| tp.trip_type == TripType::Critical && tp.is_exceeded(self.temperature_mc))
    }
...
impl HolisticThermalZone {
    ...
    pub fn cooling_utilization(&self) -> f64 {
        if self.cooling_devices.is_empty() {
            return 0.0;
        }
