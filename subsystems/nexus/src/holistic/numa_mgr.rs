...
impl HolisticNumaMgr {
    ...
    #[inline(always)]
    pub fn add_node(&mut self, id: u32, total_mem: u64) {
        self.nodes.insert(id, NumaNode::new(id, total_mem));
    }
    ...
    pub fn nearest_node(&self, from: u32) -> Option<u32> {
        self.distances
            .iter()
            .filter(|d| d.from_node == from && d.to_node != from)
    ...
    pub fn stats(&self) -> NumaMgrStats {
        ...
        NumaMgrStats {
            ...
            total_local_allocs: local,
            total_remote_allocs: remote,
            avg_local_ratio: avg_ratio,
        }
    }
}
